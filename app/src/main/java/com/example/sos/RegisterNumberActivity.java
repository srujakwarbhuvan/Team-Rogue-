        ...
        btnAddContact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (a < 5) {
                    ...
                    if (checkData) {
                        Toast.makeText(RegisterNumberActivity.this, "Contact Registered", Toast.LENGTH_SHORT).show();
                        contactName.setText("");
                        contactNumber.setText("");
                    } else {
                        Toast.makeText(RegisterNumberActivity.this, "Contact doesn't registered", Toast.LENGTH_SHORT)
                                .show();
                    }
                } else {
                ...
                if (c != null && c.getCount() > 0) {
                    ...
                    if (nameColIndex >= 0 && idColIndex >= 0 && numColIndex >= 0) {
                        ...
                        if (a < 5) {
                            ...
                            boolean checkData = databaseHelper.insertDataFunc(contactName, phone, keyword);

                            if (checkData) {
                                Toast.makeText(RegisterNumberActivity.this, "Contact is registered", Toast.LENGTH_SHORT)
                                        .show();
                            } else {
                                Toast.makeText(RegisterNumberActivity.this, "Contact doesn't registered",
                                        Toast.LENGTH_SHORT).show();
                            }
                        }

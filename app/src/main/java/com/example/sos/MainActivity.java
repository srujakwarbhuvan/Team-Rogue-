...
public class MainActivity extends AppCompatActivity {
    ...
    private void showBiometricPrompt() {
        ...
        androidx.biometric.BiometricPrompt.PromptInfo promptInfo = new androidx.biometric.BiometricPrompt.PromptInfo.Builder()
                .setTitle("Stop SOS System")
                .setSubtitle("Authenticate to stop monitoring")
    ...
    public void startServiceV(View view) {
        ...
        if (!permissionList.isEmpty()) {
            ...
            if (!isLocationEnabled) {
                // Location settings are not enabled, show a dialog to prompt the user to enable
                // them
                ...
                Task<LocationSettingsResponse> task = settingsClient
                        .checkLocationSettings(locationSettingRequestBuilder.build());
    ...
    private void updateStatusCard() {
        ...
        getTheme().resolveAttribute(com.google.android.material.R.attr.colorPrimaryContainer,
                colorPrimaryContainerValue, true);
        ...
        getTheme().resolveAttribute(com.google.android.material.R.attr.colorOnPrimaryContainer,
                colorOnPrimaryContainerValue, true);
        ...
        getTheme().resolveAttribute(com.google.android.material.R.attr.colorSurfaceVariant, colorSurfaceVariantValue,
                true);
        ...
        getTheme().resolveAttribute(com.google.android.material.R.attr.colorOnSurfaceVariant,
                colorOnSurfaceVariantValue, true);
